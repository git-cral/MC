from my_ultralytics.engine.model import Model
from my_ultralytics.nn.tasks import YOLOv10DetectionModel
...
class YOLOv10(Model, PyTorchModelHubMixin, model_card_template=card_template_text):
    ...
    def __init__(self, model='/mnt/zhouzj/mycode/my_ultralytics/cfg/models/v10/yolov10l.yaml', task=None, verbose=False, 
                 names=None, device=None):
        super().__init__(model=model, task=task, verbose=verbose, device=device)
