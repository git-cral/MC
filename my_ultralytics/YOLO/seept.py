...
# Add the project root to the Python path to allow loading of custom modules.
# This assumes the script is located in the project root folder.
project_root = os.path.dirname(os.path.abspath(__file__))
if project_root not in sys.path:
    sys.path.insert(0, project_root)
import my_ultralytics
