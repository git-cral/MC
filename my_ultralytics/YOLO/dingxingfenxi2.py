...
# 1. 定义你的模型
MODELS_TO_COMPARE = {
    "MyModel_a=0.5": {"path": "/mnt/zhouzj/mycode/runner/vit/CSPeg_0.5/weights/best.pt", "imgsz": 800},
    "MyModel_a=0.9": {"path": "/mnt/zhouzj/mycode/runner/vit/notv10detect/weights/best.pt", "imgsz": 800},
    "RT-DETR-R50": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/results/DETRDUO/weights/best.pt", "imgsz": 640},
    "YOLO v5l": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/v5DUO/weights/best.pt", "imgsz": 640},
    "YOLO v8l": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/v8l/v8l2/weights/best.pt", "imgsz": 640},
    "YOLO v9c": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/v9DUO/weights/best.pt", "imgsz": 640},
    "YOLO v10l": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/v10lduo/v10lduo/weights/best.pt", "imgsz": 640},
    "YOLO v11l": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/results/v11lDUO/weights/best.pt", "imgsz": 640},
    "YOLO v12l": {"path": "/mnt/zhouzj/mycode/runner/run_yolo/results/v12l_DUO/weights/best.pt", "imgsz": 640},
}
# 2. 定义类别颜色
CLASS_COLORS = {
...
# 4. 指定图片文件夹
IMAGES_DIR = "/mnt/zhouzj/mycode/urpc2020/dingxingfenxi1"
# 5. 根输出文件夹路径
OUTPUT_DIR = "/mnt/zhouzj/mycode/dingxingfenxi/URPC4"
# 6. 推理参数
CONF_THRESHOLD = 0.05
# 7. 设备选择
DEVICE = 'cuda:0'
...
def compare_models():
    ...
    for image_path in tqdm(image_paths, desc="处理图片"):
        ...
        for name, model in models.items():
            ...
            try:
                results = model.predict(source=original_image, imgsz=model_config['imgsz'], conf=CONF_THRESHOLD, device=DEVICE, verbose=False)
